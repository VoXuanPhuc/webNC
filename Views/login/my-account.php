            ...
            <div class="content-navbar">
                ...
                <ul class="container-info-list">
                    <li class="container-info-item container-info-item-active">
                        <a href="#" class="container-info-link">Tài khoản của tôi</a>
                    </li>
                ...
                <div class="content">
                    <div class="content-info" id="dangky">
                        <div class="">
                            ...
                            <div class="info-form">
                                <form action="<?php echo URL; ?>buyer/login-signup/?act=taikhoan&xuli=update" method="post">
                                    <label for="" class="content-info-text">Họ</label>
                                    <input class="lg_dangnhap-input" placeholder="Họ" name="Ho" type="text" value="<?php echo  $data['Ho'] ?>" ><br><br>
                                    <label for="" class="content-info-text">Tên</label>
                                    <input class="lg_dangnhap-input" placeholder="Tên" name="Ten" type="text" value="<?php echo  $data['Ten'] ?>" ><br><br>
                                    <label for="" class="content-info-text">Giới tính</label>
                                    <input class="lg_dangnhap-input" placeholder="Giới tính" name="GioiTinh" type="text" value="<?php echo  $data['GioiTinh'] ?>" ><br><br>
                                    <label for="" class="content-info-text">Số điện thoại</label>
                                    <input class="lg_dangnhap-input" placeholder="Số điện thoại" name="SĐT" type="text" pattern="[0-9]+" minlength="10" value="<?php echo  $data['SDT'] ?>" ><br><br>
